...
public class Register extends AppCompatActivity implements View.OnClickListener{
    ...
    private void UserRegister() {
        ...
        if (TextUtils.isEmpty(Name)){
            Toast.makeText(Register.this, "Introduce Nombre", Toast.LENGTH_SHORT).show();
            return;
            ...
            Toast.makeText(Register.this,"La contraseña debe ser mayor a 6 digitos",Toast.LENGTH_SHORT).show();
            return;
        }
        mDialog.setMessage("Creando usuario por favor espera...");
                        ...
                        public void onComplete(@NonNull Task task) {
                            ...
                            if (task.isSuccessful()) {
                                Toast.makeText(Register.this,
                                        "Email de verificacion enviado a " + user.getEmail(),
                                        Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(Register.this,
                                        "Error al enviar el email de verificacion.",
                                        Toast.LENGTH_SHORT).show();
                            }
                        }
                    });

...
public class Login extends AppCompatActivity {
    ...
    private void userSign() {
        ...
        if (TextUtils.isEmpty(email)) {
            Toast.makeText(Login.this, "Introduce el email", Toast.LENGTH_SHORT).show();
            return;
        } else if (TextUtils.isEmpty(password)) {
            Toast.makeText(Login.this, "Introduce la contraseña", Toast.LENGTH_SHORT).show();
            return;
        }
        dialog.setMessage("Iniciando sesion por favor espera...");
    ...
    private void checkIfEmailVerified(){
        ...
        if(!emailVerified){
            Toast.makeText(this,"Verificar el email enviado",Toast.LENGTH_SHORT).show();
            mAuth.signOut();
            finish();
        }
        else {
